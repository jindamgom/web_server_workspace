...
<div class="xl:container mx-auto p-8">
    ...
    <div class="w-full my-2">
        ...
        action ="${pageContext.request.contextPath}/board/boardCommentCreate" method="post">
    ...
    <!-- 댓글 테이블 -->
    <div class="relative my-10 shadow-xl sm:rounded-lg">
            ...
            <c:forEach items="${board.comments}" var="comment" varStatus="vs">
                <c:if test="${comment.commentLevel eq 1}">
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <%-- 작성자 본인과 관리자에게만 노출이 되어야 한다.--%>
                            <c:if test="${loginMember.role eq Role.A or loginMember.id eq comment.memberId}">
                            <div class="flex">
